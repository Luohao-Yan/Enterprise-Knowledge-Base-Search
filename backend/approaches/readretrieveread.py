...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent assistant helping Contoso Inc employees questions and employee handbook questions.Reply in Chinese with a non-short summary to the user  " \
