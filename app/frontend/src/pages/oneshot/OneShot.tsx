    ...
    return (
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <h1 className={styles.oneshotTitle}>查询你的文档内容</h1>
                <div className={styles.oneshotQuestionInput}>
                    <QuestionInput placeholder="示例：什么是云原生？" disabled={isLoading} onSend={question => makeApiRequest(question)} />
                </div>
            </div>
            <div className={styles.oneshotBottomSection}>
                {isLoading && <Spinner label="正在生成答案中" />}
